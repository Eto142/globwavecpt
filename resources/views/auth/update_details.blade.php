...
<head>
    ...
    <title>Global Wave Capital | Update Details</title>
...
<body>
    ...
    {{-- <script>
        ...
        document.getElementById('updateDetails').addEventListener('submit', function(e) {
            ...
            if (!country || !state || !pcode || !address || !phone) {
                responseDiv.innerHTML = '<div class="alert alert-danger">Please fill in all required fields.</div>';
                resetButton();
                return false;
            }
            ...
            setTimeout(() => {
                // Success simulation
                responseDiv.innerHTML = '<div class="alert alert-success">Details updated successfully!</div>';
